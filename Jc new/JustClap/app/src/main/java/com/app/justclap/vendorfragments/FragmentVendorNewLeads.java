...
import com.app.justclap.vendoradapter.AdapterVendorNewleads;
...
public class FragmentVendorNewLeads extends Fragment implements OnCustomItemClicListener, ApiResponse {

    private Context context;
    private RecyclerView recycler_request;
    private ArrayList<ModelVendor> listRequests;
    private AdapterVendorNewleads adapterUserRequests;
        ...
        try {
            if (method == 1) {
                ...
                if (commandResult.getString("success").equalsIgnoreCase("1")) {
                    ...
                    adapterUserRequests = new AdapterVendorNewleads(context, FragmentVendorNewLeads.this, listRequests);
