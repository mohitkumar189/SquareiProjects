 ...
 */
public class AdapterTrendingServices extends RecyclerView.Adapter<AdapterTrendingServices.CustomViewHolder> {
    ArrayList<ModelService> detail;
    Context mContext;
    OnCustomItemClicListener listener;


    public AdapterTrendingServices(Context context, OnCustomItemClicListener lis, ArrayList<ModelService> list) {
