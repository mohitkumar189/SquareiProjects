...
public class AdapterGallery extends RecyclerView.Adapter<AdapterGallery.CustomViewHolder> {
    ...
    public AdapterGallery(Context context, OnCustomItemClicListener lis, ArrayList<ModelService> list) {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.row_gallery_adapter, viewGroup, false);
