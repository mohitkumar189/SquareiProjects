 ...
 */
public class AdapterAllServices extends RecyclerView.Adapter<AdapterAllServices.CustomViewHolder> {
    ArrayList<ModelService> detail;
    Context mContext;
    OnCustomItemClicListener listener;


    public AdapterAllServices(Context context, OnCustomItemClicListener lis, ArrayList<ModelService> list) {
