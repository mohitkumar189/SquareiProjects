...
import com.app.justclap.vendorfragments.FragmentVendorCompletedLeads;
import com.app.justclap.vendorfragments.FragmentVendorNewLeads;
import com.app.justclap.vendorfragments.FragmentVendorOngoingLeads;
...
public class VendorUniDashboard extends AppCompatActivity
    ...
    private ImageView image_cross, image_notification, image_wallet;
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                switch (tab.getPosition()) {
                    ...
                    case 1:
                        ...
                        imageView1.setImageResource(R.drawable.ongoing_blue);
                        break;
                    case 2:
                        ImageView imageView2 = (ImageView) tab.getCustomView().findViewById(R.id.image_view);
                        imageView2.setImageResource(R.drawable.completed_blue);
                        break;
                    case 3:
                        ImageView imageView3 = (ImageView) tab.getCustomView().findViewById(R.id.image_view);
                        imageView3.setImageResource(R.drawable.chat_blue);
                        break;
                }
            ...
            public void onTabUnselected(TabLayout.Tab tab) {
                switch (tab.getPosition()) {
                    ...
                    case 2:
                        ImageView imageView2 = (ImageView) tab.getCustomView().findViewById(R.id.image_view);
                        imageView2.setImageResource(R.drawable.completed_grey);
                        break;
                    case 3:
                        ImageView imageView3 = (ImageView) tab.getCustomView().findViewById(R.id.image_view);
                        imageView3.setImageResource(R.drawable.chat_grey);
                        break;
                }
            }
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new FragmentVendorNewLeads(), "New Leads");
        adapter.addFrag(new FragmentVendorOngoingLeads(), "OnGoing");
        adapter.addFrag(new FragmentVendorCompletedLeads(), "Completed");
