...
public class AdapterPopularServices extends RecyclerView.Adapter<AdapterPopularServices.CustomViewHolder> {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.row_popular_services, viewGroup, false);
    ...
    public void onBindViewHolder(CustomViewHolder customViewHolder, final int position) {
        ...
        Log.e("imageurl", "*" + detail.get(position).getServiceIcon());

        customViewHolder.rl_background.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                listener.onItemClickListener(position, 12);
            }
        });
