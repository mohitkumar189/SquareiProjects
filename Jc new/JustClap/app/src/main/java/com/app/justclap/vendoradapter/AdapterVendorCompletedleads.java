...
public class AdapterVendorCompletedleads extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterVendorCompletedleads(Context context, OnCustomItemClicListener lis, ArrayList<ModelVendor> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.row_vendor_cmpletedleads, parent, false);
