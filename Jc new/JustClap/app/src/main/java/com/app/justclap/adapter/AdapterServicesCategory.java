 ...
 */
public class AdapterServicesCategory extends RecyclerView.Adapter<AdapterServicesCategory.CustomViewHolder> {
    ArrayList<ModelService> detail;
    Context mContext;
    OnCustomItemClicListener listener;


    public AdapterServicesCategory(Context context, OnCustomItemClicListener lis, ArrayList<ModelService> list) {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.row_services_category, viewGroup, false);
