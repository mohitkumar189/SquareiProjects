...
import com.app.justclap.model.ModelWallet;
import com.app.justclap.utils.AppUtils;
import com.app.justclap.vendoradapter.AdapterWallet;
 ...
 */
public class Vendor_Wallet extends AppCompatActivity implements OnCustomItemClicListener, ApiResponse {
    ...
    private void init() {
        ...
        AppUtils.fontGotham_Medium(text_balance,context);
    ...
    private void getWalletDetails() {
        ...
        try {
            ...
            if (!cd.isConnectingToInternet()) {
                ...
                hm.put("vendorID", AppUtils.getUserId(context));
                hm.put("skipCount", "0");

                String url = getResources().getString(R.string.url_base_new) + getResources().getString(R.string.getWalletDetails);
...
*/
                            ...
                            hm1.put("transaction_id", hm.get("TXNID"));
                            hm1.put("order_id", orderId);
                            hm1.put("vendorID", AppUtils.getvendorId(context));
                            hm1.put("status", "1");
                            hm1.put("TXNAMOUNT", hm.get("TXNAMOUNT"));

                            String url = getResources().getString(R.string.url_base_new) + getResources().getString(R.string.getWalletDetails);
                            new CommonAsyncTaskHashmap(3, context, Vendor_Wallet.this).getqueryJson(url, hm1);
...
*/
                            ...
                            hm1.put("TXNAMOUNT", hm.get("TXNAMOUNT"));
                            String url = getResources().getString(R.string.url_base_new) + getResources().getString(R.string.getWalletDetails);
                            new CommonAsyncTaskHashmap(4, context, Vendor_Wallet.this).getqueryJson(url, hm1);
        ...
        text_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!edit_recharge.getText().toString().equalsIgnoreCase("")) {
                    ...
                    Toast.makeText(Vendor_Wallet.this, "Please enter recharge amount", Toast.LENGTH_SHORT).show();
                }
            }
        });
                            ...
                            if (loading) {
                                if ((visibleItemCount + pastVisiblesItems) >= totalItemCount) {
                                    ...
                                    try {
                                        ...
                                        HashMap<String, String> hm1 = new HashMap<>();
                                        List<NameValuePair> params = new ArrayList<NameValuePair>();
                                        hm1.put("vendorID", AppUtils.getUserId(context));
                                        hm1.put("skipCount", skipCount + "");

                                        String url = getResources().getString(R.string.url_base_new) + getResources().getString(R.string.getWalletDetails);
                                        new CommonAsyncTaskHashmap(4, context, Vendor_Wallet.this).getqueryJsonNoProgress(url, hm1);
