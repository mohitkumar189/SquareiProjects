 ...
 */
public class AdapterVendorRequest extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterVendorRequest(Context context, OnCustomItemClicListener lis, ArrayList<ModelVendor> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.row_vendor_reuest, parent, false);
