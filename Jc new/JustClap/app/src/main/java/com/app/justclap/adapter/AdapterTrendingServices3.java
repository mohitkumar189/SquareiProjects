 ...
 */
public class AdapterTrendingServices3 extends RecyclerView.Adapter<AdapterTrendingServices3.CustomViewHolder> {
    ArrayList<ModelService> detail;
    Context mContext;
    OnCustomItemClicListener listener;


    public AdapterTrendingServices3(Context context, OnCustomItemClicListener lis, ArrayList<ModelService> list) {
