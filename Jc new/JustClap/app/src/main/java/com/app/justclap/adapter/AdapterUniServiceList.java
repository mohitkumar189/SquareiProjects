 ...
 */
public class AdapterUniServiceList extends RecyclerView.Adapter<AdapterUniServiceList.CustomViewHolder> {
    ArrayList<ModelService> detail;
    Context mContext;
    OnCustomItemClicListener listener;


    public AdapterUniServiceList(Context context, OnCustomItemClicListener lis, ArrayList<ModelService> list) {
