 ...
 */
public class AdapterBanner extends RecyclerView.Adapter<AdapterBanner.CustomViewHolder> {
    ArrayList<ModelService> detail;
    Context mContext;
    OnCustomItemClicListener listener;


    public AdapterBanner(Context context, OnCustomItemClicListener lis, ArrayList<ModelService> list) {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.row_banner_adapter, viewGroup, false);
