 ...
 */
public class AdapterVendorLeads extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterVendorLeads(Context context, OnCustomItemClicListener lis, ArrayList<ModelVendor> list) {
