...
import com.app.justclap.vendoradapter.AdapterVendorRequest;
...
public class FragmentVendorRequest extends Fragment implements OnCustomItemClicListener, ApiResponse {

    private Context context;
    private RecyclerView recycler_request;
    private ArrayList<ModelVendor> listRequests;
    private AdapterVendorRequest adapterUserRequests;
        ...
        try {
            if (method == 1) {
                ...
                if (commandResult.getString("success").equalsIgnoreCase("1")) {
                    ...
                    adapterUserRequests = new AdapterVendorRequest(context, FragmentVendorRequest.this, listRequests);
