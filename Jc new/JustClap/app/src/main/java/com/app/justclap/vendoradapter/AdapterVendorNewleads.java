 ...
 */
public class AdapterVendorNewleads extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterVendorNewleads(Context context, OnCustomItemClicListener lis, ArrayList<ModelVendor> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.row_vendor_newleads, parent, false);
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView text_name, text_email, text_requestcode, text_date, text_name_title, text_distance;
