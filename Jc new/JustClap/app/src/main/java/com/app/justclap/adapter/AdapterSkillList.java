 ...
 */
public class AdapterSkillList extends RecyclerView.Adapter<AdapterSkillList.CustomViewHolder> {
    ArrayList<String> detail;
    Context mContext;
    OnCustomItemClicListener listener;


    public AdapterSkillList(Context context, OnCustomItemClicListener lis, ArrayList<String> list) {
        this.detail = list;
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.row_skilllist, viewGroup, false);
