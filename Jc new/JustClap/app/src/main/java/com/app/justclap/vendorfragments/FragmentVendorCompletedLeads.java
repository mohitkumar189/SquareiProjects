...
import com.app.justclap.vendoradapter.AdapterVendorCompletedleads;
...
public class FragmentVendorCompletedLeads extends Fragment implements OnCustomItemClicListener, ApiResponse {

    private Context context;
    private RecyclerView recycler_request;
    private ArrayList<ModelVendor> listRequests;
    private AdapterVendorCompletedleads adapterVendorCompletedleads;
    ...
    private void getRequestData() {
        try {
            if (AppUtils.isNetworkAvailable(context)) {
                ...
                String url = getResources().getString(R.string.url_base_new) + getResources().getString(R.string.oldLeadsByVendorId);
        ...
        try {
            if (method == 1) {
                ...
                if (commandResult.getString("success").equalsIgnoreCase("1")) {
                    ...
                    JSONArray requests = maindata.getJSONArray("CompletedLeads");
                    ...
                    adapterVendorCompletedleads = new AdapterVendorCompletedleads(context, FragmentVendorCompletedLeads.this, listRequests);
                    recycler_request.setAdapter(adapterVendorCompletedleads);
