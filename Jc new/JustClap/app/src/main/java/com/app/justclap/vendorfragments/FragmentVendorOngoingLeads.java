...
import com.app.justclap.vendoradapter.AdapterVendorOngoingleads;
...
public class FragmentVendorOngoingLeads extends Fragment implements OnCustomItemClicListener, ApiResponse {

    private Context context;
    private RecyclerView recycler_request;
    private ArrayList<ModelVendor> listRequests;
    private AdapterVendorOngoingleads adapterVendorOngoingleads;
        ...
        try {
            if (method == 1) {
                ...
                if (commandResult.getString("success").equalsIgnoreCase("1")) {
                    ...
                    JSONArray requests = maindata.getJSONArray("OngoingLeads");
                    ...
                    adapterVendorOngoingleads = new AdapterVendorOngoingleads(context, FragmentVendorOngoingLeads.this, listRequests);
                    recycler_request.setAdapter(adapterVendorOngoingleads);
