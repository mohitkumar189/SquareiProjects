...
public class AsyncPostDataResponseNoProgress extends AsyncTask<String, Void, String> {
    String url;
    int method;
    Context context;
    ...
    public AsyncPostDataResponseNoProgress(Context context, int method,
    ...
    public AsyncPostDataResponseNoProgress(android.support.v4.app.Fragment _context, int method,
                                           List<NameValuePair> requestData, String url) {
        // TODO Auto-generated constructor stub
    ...
    protected String doInBackground(String... params) {
        ...
        HttpConnectionParams
                .setConnectionTimeout(httpclient.getParams(), 33000);
