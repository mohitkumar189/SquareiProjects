 ...
 */
public class AdapterOnGoing extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterOnGoing(Context context, OnCustomItemClicListener lis, ArrayList<ModelService> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.row_booking_ongoing, parent, false);
