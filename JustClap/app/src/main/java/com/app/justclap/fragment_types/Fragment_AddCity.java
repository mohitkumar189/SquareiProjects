...
import com.app.justclap.activities.SelectCityMap;
 ...
 */
public class Fragment_AddCity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        text_addcity = (TextView) viewCategory.findViewById(R.id.text_addcity);
    ...
    private void setListener() {
        ...
        text_addcity.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent in = new Intent(getActivity(), SelectCityMap.class);
