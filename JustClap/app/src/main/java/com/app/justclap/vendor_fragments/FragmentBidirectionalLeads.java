...
import com.app.justclap.adapters.AdapterVendorideirectionalLeads;
 ...
 */
public class FragmentBidirectionalLeads extends Fragment implements OnCustomItemClicListener, ListenerPostData {


    RecyclerView mRecyclerView;
    AdapterVendorideirectionalLeads adapterVendorideirectionalLeads;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View viewProfile = inflater.inflate(R.layout.fragment_vendor_leads, container, false);
        context = getActivity();
    ...
    private void hitService() {
        ...
        try {
            ...
            if (!cd.isConnectingToInternet()) {
                ...
                new AsyncPostDataFragment(getActivity(), FragmentBidirectionalLeads.this, 1, nameValuePairs,
    ...
    private void refreshItems() {
        ...
        try {
            ...
            if (!cd.isConnectingToInternet()) {
                ...
                new AsyncPostDataResponseNoProgress(FragmentBidirectionalLeads.this, 2, nameValuePairs,
                        getString(R.string.url_base_new)
                                + getString(R.string.ongoingLeadsOfVendor));
                        ...
                        if (dy > 0) //check for scroll down
                        {
                            ...
                            if (loading) {
                                if ((visibleItemCount + pastVisiblesItems) >= totalItemCount) {
                                    ...
                                    adapterVendorideirectionalLeads.notifyDataSetChanged();
                                    ...
                                    try {
                                        ...
                                        new AsyncPostDataResponseNoProgress(FragmentBidirectionalLeads.this, 3, nameValuePairs,
                                                getString(R.string.url_base_new)
                                                        + getString(R.string.ongoingLeadsOfVendor));
        ...
        try {
            ...
            if (position == 1) {
                ...
                if (commandResult.getString("success").equalsIgnoreCase("1")) {
                    ...
                    adapterVendorideirectionalLeads = new AdapterVendorideirectionalLeads(context, this, service_list);
                    mRecyclerView.setAdapter(adapterVendorideirectionalLeads);
