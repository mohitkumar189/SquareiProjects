...
public class AsyncPostDataFragmentNoProgress extends AsyncTask<String, Void, String> {
	String url;
	int method;
	Context context;
	...
	public AsyncPostDataFragmentNoProgress(Context context, ListenerPostData fragment, int method,
