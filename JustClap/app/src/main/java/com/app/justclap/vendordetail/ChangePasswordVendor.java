...
import com.app.justclap.activities.ConnectionDetector;
...
public class ChangePasswordVendor extends AppCompatActivity implements ListenerPostData {
                    ...
                    if (isValidLoginDetails()) {
                        try {
                            ...
                            params.add(new BasicNameValuePair("email",
                                    AppUtils.getvendorEmail(context)));
...
//
                    ...
                    /*AppUtils.showCustomAlert(ChangePasswordVendor.this,
    ...
    public void onPostRequestFailed(int method, String message) {
        // TODO Auto-generated method stub
        Log.e("Error", "***" + message);
        AppUtils.showCustomAlert(ChangePasswordVendor.this, getResources().getString(R.string.problem_server));
    }
