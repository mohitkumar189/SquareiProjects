 ...
 */
public class AdapterRequestCompleted extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterRequestCompleted(Context context, OnCustomItemClicListener lis, ArrayList<ModelService> list) {
     ...
     /*   View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.row_shipmentlist, null);
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.row_service_detail, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int i) {
        ...
        if (holder instanceof CustomViewHolder) {
            ...
            ((CustomViewHolder) holder).text_hire.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        TextView text_services_name, distance, text_serviceAssigned, text_quoted_detail, review_count, text_chats, text_phone, text_profile, text_hire;
