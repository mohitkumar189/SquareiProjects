...
import com.app.justclap.adapters.AdapterVendorCompletedLeads;
...
/**
 * Created by hemanta garg on 12-02-2016.
 */
public class FragmentCompletedLeads extends Fragment implements OnCustomItemClicListener, ListenerPostData {


    RecyclerView mRecyclerView;
    AdapterVendorCompletedLeads adapterVendorCompletedLeads;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View viewProfile = inflater.inflate(R.layout.fragment_vendor_complete_booking, container, false);
        context = getActivity();
    ...
    private void hitService() {
        ...
        try {
            ...
            if (!cd.isConnectingToInternet()) {
                ...
                new AsyncPostDataResponse(FragmentCompletedLeads.this, 1, nameValuePairs,
                        getString(R.string.url_base_new)
                                + getString(R.string.completedLeadsOfVendor));
                        ...
                        if (dy > 0) //check for scroll down
                        {
                            ...
                            if (loading) {
                                if ((visibleItemCount + pastVisiblesItems) >= totalItemCount) {
                                    ...
                                    adapterVendorCompletedLeads.notifyDataSetChanged();
                                    ...
                                    try {
                                        ...
                                        new AsyncPostDataResponseNoProgress(FragmentCompletedLeads.this, 3, nameValuePairs,
                                                getString(R.string.url_base_new)
                                                        + getString(R.string.completedLeadsOfVendor));
    ...
    void refreshItems() {
        ...
        try {
            ...
            if (!cd.isConnectingToInternet()) {
                ...
                new AsyncPostDataResponseNoProgress(FragmentCompletedLeads.this, 2, nameValuePairs,
                        getString(R.string.url_base_new)
                                + getString(R.string.completedLeadsOfVendor));
        ...
        try {
            ...
            if (position == 1) {
                ...
                if (commandResult.getString("success").equalsIgnoreCase("1")) {
                    ...
                    adapterVendorCompletedLeads = new AdapterVendorCompletedLeads(context, this, service_list);
                    mRecyclerView.setAdapter(adapterVendorCompletedLeads);
