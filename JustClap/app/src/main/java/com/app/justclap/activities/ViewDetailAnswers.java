...
public class ViewDetailAnswers extends AppCompatActivity implements ListenerPostData, OnCustomItemClicListener {
    ...
    Toolbar toolbar;
    String date = "", userId = "", searchId = "", customerResponse = "";
    private BroadcastReceiver broadcastReceiver;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_view_detail_answers);
        ...
        if (in.hasExtra("CustomerResponse")) {
    ...
    private void hitService() {
        ...
        try {
            ...
            if (!cd.isConnectingToInternet()) {
                ...
                new AsyncPostDataResponse(ViewDetailAnswers.this, 1, nameValuePairs,
    ...
    public void onPostRequestFailed(int position, String response) {
        AppUtils.showCustomAlert(ViewDetailAnswers.this, getResources().getString(R.string.problem_server));
    }
