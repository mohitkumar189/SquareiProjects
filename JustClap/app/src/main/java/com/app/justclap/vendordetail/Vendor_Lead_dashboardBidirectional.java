 ...
 */
public class Vendor_Lead_dashboardBidirectional extends AppCompatActivity implements OnCustomItemClicListener, ListenerPostData {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vendor_lead_dashboard_bidirectional);
        ...
        vendorDashboardPagerAdapterBidirectional = new VendorDashboardPagerAdapterBidirectional(getSupportFragmentManager(), 3);
        pager.setAdapter(vendorDashboardPagerAdapterBidirectional);
        tabLayout.setupWithViewPager(pager);
        setupTabIconsBidirectional();
        rl_sharejob.setVisibility(View.VISIBLE);
    ...
    private void setupTabIconsBidirectional() {
        ...
        TextView tabtwo = (TextView) LayoutInflater.from(this).inflate(R.layout.custom_tab, null);
        tabtwo.setText("Leads");
        tabtwo.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.newleads, 0, 0);
  ...
  /*  @Override
    ...
    private void setListener() {
        rl_about.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent in = new Intent(Vendor_Lead_dashboardBidirectional.this, AboutUs.class);
                startActivity(in);
        ...
        rl_terms.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                drawerLayout.closeDrawer(frameLayout);
                Intent in = new Intent(Vendor_Lead_dashboardBidirectional.this, TermsAndconditions.class);
                startActivity(in);
        ...
        rl_privacy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                drawerLayout.closeDrawer(frameLayout);
                Intent in = new Intent(Vendor_Lead_dashboardBidirectional.this, PrivacyPolicy.class);
                startActivity(in);
        ...
        fab_share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent in = new Intent(Vendor_Lead_dashboardBidirectional.this, QuestionPage.class);
        ...
        rl_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                drawerLayout.closeDrawer(frameLayout);
                Intent in = new Intent(Vendor_Lead_dashboardBidirectional.this, Vendor_Lead_dashboardBidirectional.class);
                startActivity(in);
                finish();
        ...
        rl_works.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                drawerLayout.closeDrawer(frameLayout);
                Intent in = new Intent(Vendor_Lead_dashboardBidirectional.this, ActivityHome.class);
        ...
        rl_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                drawerLayout.closeDrawer(frameLayout);
                Intent in = new Intent(Vendor_Lead_dashboardBidirectional.this, VendorLogin.class);
        ...
        rl_profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                drawerLayout.closeDrawer(frameLayout);
                Intent in = new Intent(Vendor_Lead_dashboardBidirectional.this, Vendor_homePage.class);
                startActivity(in);
        ...
        rl_credits.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                drawerLayout.closeDrawer(frameLayout);
                Intent in = new Intent(Vendor_Lead_dashboardBidirectional.this, Vendor_Wallet.class);
                startActivity(in);
        ...
        rl_contact.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                drawerLayout.closeDrawer(frameLayout);
                Intent in = new Intent(Vendor_Lead_dashboardBidirectional.this, ContactUs.class);
                startActivity(in);
        ...
        rl_setting.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                drawerLayout.closeDrawer(frameLayout);
                Intent in = new Intent(Vendor_Lead_dashboardBidirectional.this, ActivitySetting.class);
    ...
    private void showLogoutBox() {
        ...
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(
                Vendor_Lead_dashboardBidirectional.this);
                ...
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        try {
                            ...
                            new AsyncPostDataResponse(Vendor_Lead_dashboardBidirectional.this, 3, nameValuePairs,
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.wallet_icon) {
            ...
            Intent intent = new Intent(Vendor_Lead_dashboardBidirectional.this, Vendor_Wallet.class);
            startActivity(intent);
        }
        if (id == R.id.notification_icon) {

            Intent intent = new Intent(Vendor_Lead_dashboardBidirectional.this, ActivityNotification.class);
            startActivity(intent);
        }
        ...
        try {
            if (position == 3) {
                ...
                if (commandResult.getString("success").equalsIgnoreCase("1")) {
                    ...
                    Intent in = new Intent(Vendor_Lead_dashboardBidirectional.this, DashBoardActivity.class);
                    startActivity(in);
                    finish();
