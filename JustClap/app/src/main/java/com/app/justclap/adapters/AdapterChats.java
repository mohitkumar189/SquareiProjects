...
import com.app.justclap.model.ModelChatContactList;
...
public class AdapterChats extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    ArrayList<ModelContactList> detail;
    Context mContext;
    ...
    public AdapterChats(Context context, OnCustomItemClicListener lis, ArrayList<ModelContactList> list) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int i) {
        ...
        if (holder instanceof CustomViewHolder) {
            ...
            ModelContactList m1 = (ModelContactList) detail.get(i);
    ...
    public int getItemViewType(int position) {
        ModelContactList m1 = (ModelContactList) detail.get(position);
