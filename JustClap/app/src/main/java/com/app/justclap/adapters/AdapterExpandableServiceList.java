 ...
 */
public class AdapterExpandableServiceList extends BaseAdapter {
    ...
    public AdapterExpandableServiceList(Context context, OnCustomItemClicListener lis, ArrayList<ModelService> list) {
