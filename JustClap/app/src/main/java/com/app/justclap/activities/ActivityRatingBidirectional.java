 ...
 */
public class ActivityRatingBidirectional extends AppCompatActivity implements ListenerPostData {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (edtAddress_edtcomment.getText().toString().equalsIgnoreCase("")) {
                    ...
                    AppUtils.showCustomAlert(ActivityRatingBidirectional.this, "Please give your review");
    ...
    private void submitRating() {
        ...
        try {
            ...
            if (!cd.isConnectingToInternet()) {
                ...
                AppUtils.showCustomAlert(ActivityRatingBidirectional.this, getResources().getString(R.string.message_network_problem));
                ...
                new AsyncPostDataResponse(ActivityRatingBidirectional.this, 1, nameValuePairs,
                        getString(R.string.url_base_new)
                                + getString(R.string.setReviewBidirectional));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            if (position == 1) {
                ...
                if (commandResult.getString("success").equalsIgnoreCase("1")) {
                    ...
                    Intent iintent = new Intent(ActivityRatingBidirectional.this, ActivityRatingReviewSuccess.class);
    ...
    public void onPostRequestFailed(int position, String response) {
        AppUtils.showCustomAlert(ActivityRatingBidirectional.this, getResources().getString(R.string.problem_server));
    }
}
