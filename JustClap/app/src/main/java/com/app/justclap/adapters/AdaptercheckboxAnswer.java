 ...
 */
public class AdaptercheckboxAnswer extends BaseAdapter {
    ...
    public AdaptercheckboxAnswer(Context mContext,
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.checked_item.setEnabled(false);
            holder.checked_item.setClickable(false);
        ...
        try {
          ...
          /*  if(getSelectedItem==true)
            {
                holder.checked_item.setChecked(true);
            }
            else {
                holder.checked_item.setChecked(false);
            }*/
