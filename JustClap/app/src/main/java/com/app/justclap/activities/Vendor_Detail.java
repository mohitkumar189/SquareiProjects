 ...
 */
public class Vendor_Detail extends AppCompatActivity implements OnCustomItemClicListener, ListenerPostData {


    Context context;
    ImageView image_background;
    VendoDetailPagerAdapter vendoDetailPagerAdapter;
    TextView text_vendor_name, text_hirenow;
    ...
    String vendor_id = "", service_id = "", vendorImage = "", mobileNumber = "", searchId = "", flag = "", service_name = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vendor_deatil);
        ...
        if (in.hasExtra("flag")) {
            ...
            if (in.getExtras().getString("flag").equalsIgnoreCase("1")) {
                text_hirenow.setVisibility(View.VISIBLE);
            } else if (in.getExtras().getString("flag").equalsIgnoreCase("2")) {
                text_hirenow.setVisibility(View.GONE);
            } else if (in.getExtras().getString("flag").equalsIgnoreCase("3")) {
                text_hirenow.setVisibility(View.GONE);
                ll_call.setVisibility(View.GONE);
            } else if (in.getExtras().getString("flag").equalsIgnoreCase("4")) {
                text_hirenow.setVisibility(View.VISIBLE);
                text_hirenow.setText("Complete");
            }
        }
...
*/
    ...
    private void hireNow() {
        ...
        try {
            ...
            if (!cd.isConnectingToInternet()) {
                ...
                new AsyncPostDataResponse(Vendor_Detail.this, 2, nameValuePairs,
    ...
    private void getVendorData() {
        ...
        try {
            ...
            if (!cd.isConnectingToInternet()) {
                ...
                new AsyncPostDataResponse(Vendor_Detail.this, 1, nameValuePairs,
                        getString(R.string.url_base_new)
    ...
    private void init() {
        ...
        text_hirenow = (TextView) findViewById(R.id.text_hirenow);
    ...
    private void setListener() {
        ...
        text_hirenow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                if (flag.equalsIgnoreCase("4")) {

                    Intent in = new Intent(context, ActivityRating.class);
        ...
        try {
            ...
            if (position == 1) {
                ...
                if (commandResult.getString("success").equalsIgnoreCase("1")) {
                    ...
                    JSONObject data = commandResult.getJSONObject("data");
                    AppUtils.showCustomAlert(Vendor_Detail.this, commandResult.getString("message"));
    ...
    public void onPostRequestFailed(int position, String response) {
        AppUtils.showCustomAlert(Vendor_Detail.this, getResources().getString(R.string.problem_server));
