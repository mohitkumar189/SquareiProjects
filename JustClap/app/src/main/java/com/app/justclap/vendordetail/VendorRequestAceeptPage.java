...
public class VendorRequestAceeptPage extends AppCompatActivity implements OnCustomItemClicListener, ListenerPostData {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vendor_request_accept_page);
    ...
    private void hitService() {
        ...
        try {
            ...
            if (!cd.isConnectingToInternet()) {
                ...
                new AsyncPostDataResponse(VendorRequestAceeptPage.this, 1, nameValuePairs,
        ...
        text_book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (text_quote.getText().toString().equalsIgnoreCase("")) {
                    ...
                    AppUtils.showCustomAlert(VendorRequestAceeptPage.this, "Please enter price");
                    ...
                    if (!cd.isConnectingToInternet()) {
                        ...
                        new AsyncPostDataResponse(VendorRequestAceeptPage.this, 2, nameValuePairs,
                                getString(R.string.url_base_new)
            ...
            switch (type) {
                ...
                case 5:
                    ...
                    for (int k = 0; k < jo4.length(); k++) {
                        ...
                        if (date.length() > 0) {
                            date = date + ", " + j5.getString("optionText");
                        } else {
                            date = j5.getString("optionText");
                        }
        ...
        try {
            ...
            if (position == 2) {
                ...
                if (commandResult.getString("success").equalsIgnoreCase("1")) {
                    ...
                    AppUtils.showCustomAlert(VendorRequestAceeptPage.this, commandResult.getString("message"));
                    Intent in = new Intent(VendorRequestAceeptPage.this, Vendor_QuoteList.class);
                    startActivity(in);
                    finish();
    ...
    public void onPostRequestFailed(int position, String response) {
        AppUtils.showCustomAlert(VendorRequestAceeptPage.this, getResources().getString(R.string.problem_server));
    }
}
