 ...
 */
public class AdapterVendorideirectionalLeads extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterVendorideirectionalLeads(Context context, OnCustomItemClicListener lis, ArrayList<ModelService> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.row_vendor_leads, parent, false);
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        TextView text_services_name, text_email, text_requestId,  review_count, text_chats, text_phone, text_profile;
