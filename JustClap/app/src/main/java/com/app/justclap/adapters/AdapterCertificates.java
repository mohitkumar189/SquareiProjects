 ...
 */
public class AdapterCertificates extends BaseAdapter {
    ...
    public AdapterCertificates(Context mContext,
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.row_certificate, null, false);
