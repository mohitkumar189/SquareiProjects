...
public class AppUtils {
    ...
    public static void setNewOffers(Context context, String categories) {

        try {
            SharedPreferences preferences = PreferenceManager
                    .getDefaultSharedPreferences(context);
            SharedPreferences.Editor editor = preferences.edit();
            editor.putString("offers", categories);
            editor.commit();
        } catch (Exception e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
    ...
    public static String getNewOffers(Context context) {
    ...
    public static void showCustomAlertLong(Activity context, String message) {
