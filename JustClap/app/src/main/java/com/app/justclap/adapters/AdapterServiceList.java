 ...
 */
public class AdapterServiceList extends RecyclerView.Adapter<AdapterServiceList.CustomViewHolder> {
    ArrayList<ModelService> detail;
    Context mContext;
    OnCustomItemClicListener listener;
    private int lastPosition = -1;

    public AdapterServiceList(Context context, OnCustomItemClicListener lis, ArrayList<ModelService> list) {
