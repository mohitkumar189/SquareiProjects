 ...
 */
public class AdapterHomeworkPhotoDetail extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterHomeworkPhotoDetail(Context context, OnCustomItemClicListener lis, ArrayList<ModelStudent> list) {
