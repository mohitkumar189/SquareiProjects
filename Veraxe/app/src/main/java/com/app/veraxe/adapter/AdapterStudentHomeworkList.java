 ...
 */
public class AdapterStudentHomeworkList extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterStudentHomeworkList(Context context, OnCustomItemClicListener lis, ArrayList<ModelStudent> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.row_student_homeworklist, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof CustomViewHolder) {
            ...
            ((CustomViewHolder) holder).text_date.setText(m1.getDate_start() + " - " + m1.getDate_end());
