...
import com.app.veraxe.adapter.AdapterStudentTimeTable;
...
public class StudentTimeTable extends AppCompatActivity implements OnCustomItemClicListener, ApiResponse {
    ...
    AdapterStudentTimeTable adapterTimeTable;
    ...
    protected void onResume() {
        ...
        mixpanel.track("StudentTimetable", null);
        mixpanel.flush();
    }
    ...
    public void gettimetableList() {
        ...
        if (AppUtils.isNetworkAvailable(context)) {
            ...
            String url = getResources().getString(R.string.base_url) + getResources().getString(R.string.student_timetable);
