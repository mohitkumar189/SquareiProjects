 ...
 */
public class AdapterStudentFeedbackList extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterStudentFeedbackList(Context context, OnCustomItemClicListener lis, ArrayList<ModelStudent> list) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof CustomViewHolder) {
            ...
            ((CustomViewHolder) holder).text_dapartment_label.setText(m1.getDepartment_label());
