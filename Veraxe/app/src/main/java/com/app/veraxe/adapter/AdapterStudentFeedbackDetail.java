 ...
 */
public class AdapterStudentFeedbackDetail extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterStudentFeedbackDetail(Context context, OnCustomItemClicListener lis, ArrayList<ModelStudent> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.row_student_feedbackdetail, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof CustomViewHolder) {
            ...
            ((CustomViewHolder) holder).text_dapartment_label.setText(m1.getFrom());
            ((CustomViewHolder) holder).text_feedbak_type.setText(m1.getName());
            ((CustomViewHolder) holder).text_date.setText(m1.getDatetime());
            ((CustomViewHolder) holder).text_message.setText(Html.fromHtml(m1.getMessage_text()));
