 ...
 */
public class AdapterTimeTable extends RecyclerView.Adapter<AdapterTimeTable.CustomViewHolder> {
    ...
    public AdapterTimeTable(Context context, OnCustomItemClicListener lis, ArrayList<ModelTimeTable> list, ArrayList<String> periodName, ArrayList<String> daysList) {
