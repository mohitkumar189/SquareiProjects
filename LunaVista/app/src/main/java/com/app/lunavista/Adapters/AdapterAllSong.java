 ...
 */
public class AdapterAllSong extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterAllSong(Context context, OnCustomItemClicListener lis, ArrayList<ModelVideo> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.row_allsongs, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof CustomViewHolder) {
            ...
            if (m1.getIsRecording().equalsIgnoreCase("1")) {


                Picasso.with(mContext)
                        .load(m1.getRecordingThumbURL())
                        .placeholder(R.drawable.vedio_placeholder)
                        .into(((CustomViewHolder) holder).image_song);
                ((CustomViewHolder) holder).text_song_desc.setText(AppUtils.getDateFromDateString(m1.getCreated_on()));
            ...
            if (m1.getIsFavorite().equalsIgnoreCase("1")) {
                ...
                ((CustomViewHolder) holder).image_favorite.setImageResource(R.drawable.favorite_white);
            }
            ...
            ((CustomViewHolder) holder).image_user.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView image_song, image_favorite,image_user, image_share;
        CardView card_view;
