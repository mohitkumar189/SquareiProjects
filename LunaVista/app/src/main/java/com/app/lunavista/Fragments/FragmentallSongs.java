...
import com.app.lunavista.activity.Home;
import com.app.lunavista.activity.PlaySongVideo;
import com.app.lunavista.activity.UserProfile;
import com.app.lunavista.asyntask.AsyncPostDataResponse;
import com.app.lunavista.asyntask.AsyncPostDataResponseNew;
...
public class FragmentallSongs extends Fragment implements ListenerPostData, OnCustomItemClicListener, SearchView.OnQueryTextListener {
    ...
    AdapterAllSong adapterSongList;
    ...
    private void setSongsList() {
        ...
        try {
            ...
            if (!cd.isConnectingToInternet()) {
                ...
                new AsyncPostDataResponseNoProgress(FragmentallSongs.this, 1, nameValuePairs,
    ...
    public void onItemClickListener(int position, int flag) {
        ...
        if (flag == 1) {
            ...
            Log.e("like songPosition", "**" + adapterSongList.getFilter(favSongposition).getSongId());
    ...
    private void likeUnlikeSong() {
        ...
        try {
            ...
            if (!cd.isConnectingToInternet()) {
                ...
                new AsyncPostDataResponseNoProgress(FragmentallSongs.this, 4, nameValuePairs,
                        getString(R.string.url_base)
        ...
        try {
            ...
            if (!cd.isConnectingToInternet()) {
             ...
             /*   String data = URLEncoder.encode("user_id", "UTF-8")
                ...
                new AsyncPostDataResponseNoProgress(FragmentallSongs.this, 2, nameValuePairs,
                        getString(R.string.url_base)
                                + getString(R.string.url_getPublicRecordingList));
            }
        } catch (Exception e) {
                            ...
                            if (loading) {
                                if ((visibleItemCount + pastVisiblesItems) >= totalItemCount) {
                                    ...
                                    try {
                                        ...
                                        new AsyncPostDataResponseNoProgress(FragmentallSongs.this, 3, nameValuePairs,
                                                getString(R.string.url_base)
                                                        + getString(R.string.url_getPublicRecordingList));
        ...
        try {
            ...
            if (position == 1) {
                ...
                if (commandResult.getString("success").equalsIgnoreCase("1")) {
                    ...
                    adapterSongList = new AdapterAllSong(context, this, arrayListSongs);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        searchView.setOnQueryTextListener(FragmentallSongs.this);
