...
import com.app.lunavista.Adapters.AdapterDuetSong;
...
public class FragmentDuetSong extends Fragment implements ListenerPostData, OnCustomItemClicListener, SearchView.OnQueryTextListener {
    ...
    AdapterDuetSong adapterDuetSong;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.duetsong_list, container, false);
        context = getActivity();
    ...
    private void setSongsList() {
        ...
        try {
            ...
            adapterDuetSong = new AdapterDuetSong(context, this, arrayListSongs);
            mRecyclerView.setAdapter(adapterDuetSong);
    ...
    public void onItemClickListener(int position, int flag) {
        ...
        if (flag == 1) {
            ModelVideo model = adapterDuetSong.getFilter(position);
    ...
    private void likeUnlikeSong() {
        ...
        try {
            ...
            if (!cd.isConnectingToInternet()) {
                ...
                nameValuePairs
                        .add(new BasicNameValuePair(
                                "song_id", adapterDuetSong.getFilter(favSongposition).getSongId()));

                nameValuePairs
                        .add(new BasicNameValuePair(
                                "is_recording", adapterDuetSong.getFilter(favSongposition).getIsRecording()));
                ...
                new AsyncPostDataResponseNoProgress(FragmentDuetSong.this, 4, nameValuePairs,
    ...
    private void getSongsListRefresh() {
        ...
        try {
            ...
            if (!cd.isConnectingToInternet()) {
                ...
                new AsyncPostDataResponseNoProgress(FragmentDuetSong.this, 2, nameValuePairs,
                        getString(R.string.url_base)
                        ...
                        if (dy > 0) //check for scroll down
                        {
                            ...
                            if (loading) {
                                if ((visibleItemCount + pastVisiblesItems) >= totalItemCount) {
                                    ...
                                    arrayListSongs.add(modelVideo);
                                    adapterDuetSong.notifyDataSetChanged();
                                    ...
                                    try {
                                        ...
                                        new AsyncPostDataResponseNoProgress(FragmentDuetSong.this, 3, nameValuePairs,
                                                getString(R.string.url_base)
                                                        + getString(R.string.url_songsList));
    ...
    public void onPostRequestSucess(int position, String response) {
        ...
        try {
            ...
            if (position == 1) {
                ...
                if (commandResult.getString("success").equalsIgnoreCase("1")) {
                    adapterDuetSong.getFilter(favSongposition).setIsFavorite(is_like);
                    adapterDuetSong.notifyDataSetChanged();
                    //   getSongsListRefresh();
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        searchView.setOnQueryTextListener(FragmentDuetSong.this);
        ...
        MenuItemCompat.setOnActionExpandListener(item,
                new MenuItemCompat.OnActionExpandListener() {
                    ...
                    public boolean onMenuItemActionCollapse(MenuItem item) {
                        ...
                        if (arrayListSongs.size() > 0) {
                            adapterDuetSong.setFilter(arrayListSongs);
                        }
    ...
    public boolean onQueryTextSubmit(String query) {
        if (arrayListSongs.size() > 0) {
            ...
            adapterDuetSong.setFilter(filteredModelList);
        }
        return true;
    }
