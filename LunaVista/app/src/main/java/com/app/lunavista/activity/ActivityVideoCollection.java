...
public class ActivityVideoCollection extends AppCompatActivity implements ListenerPostData, OnCustomItemClicListener {
    ...
    AdapterVideoCollection adapterVideoCollection;
    ...
    private void likeUnlikeSong() {
        ...
        try {
            ...
            if (!cd.isConnectingToInternet()) {
                ...
                new AsyncPostDataResponseNoProgress(ActivityVideoCollection.this, 4, nameValuePairs,
    ...
    private void setSongsList() {
        ...
        try {
            ...
            if (!cd.isConnectingToInternet()) {
                ...
                new AsyncPostDataResponse(ActivityVideoCollection.this, 1, nameValuePairs,
                        getString(R.string.url_base)
                                + getString(R.string.url_recordingList));
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void getSongsListRefresh() {
        ...
        try {
            ...
            if (!cd.isConnectingToInternet()) {
                ...
                new AsyncPostDataResponseNoProgress(ActivityVideoCollection.this, 2, nameValuePairs,
                        getString(R.string.url_base)
                                + getString(R.string.url_recordingList));
            }
        } catch (Exception e) {
                        ...
                        if (dy > 0) //check for scroll down
                        {
                            ...
                            if (loading) {
                                if ((visibleItemCount + pastVisiblesItems) >= totalItemCount) {
                                    ...
                                    adapterVideoCollection.notifyDataSetChanged();
                                    ...
                                    try {
                                        ...
                                        new AsyncPostDataResponseNoProgress(ActivityVideoCollection.this, 3, nameValuePairs,
                                                getString(R.string.url_base)
            ...
            if (position == 1) {
                ...
                if (commandResult.getString("success").equalsIgnoreCase("1")) {
                    ...
                    for (int i = 0; i < data.length(); i++) {
                        ...
                        modelVideo.setSongThumb(jo.getString("recordingThumbURL"));
                        ...
                        modelVideo.setSongDescription(jo.getString("recordingRemarks"));
                    ...
                    adapterVideoCollection = new AdapterVideoCollection(context, this, arrayListSongs);
                    mRecyclerView.setAdapter(adapterVideoCollection);
