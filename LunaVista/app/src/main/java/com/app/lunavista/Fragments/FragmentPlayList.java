...
public class FragmentPlayList extends Fragment implements ListenerPostData, OnCustomItemClicListener, SearchView.OnQueryTextListener {
    ...
    public void onItemClickListener(int position, int flag) {
        if (flag == 1) {
            ModelVideo model = adapterPlayList.getFilter(position);
    ...
    private void likeUnlikeSong() {
        ...
        try {
            ...
            if (!cd.isConnectingToInternet()) {
                ...
                nameValuePairs
                        .add(new BasicNameValuePair(
                                "song_id", adapterPlayList.getFilter(favSongposition).getSongId()));
                nameValuePairs
                        .add(new BasicNameValuePair(
                                "is_recording", adapterPlayList.getFilter(favSongposition).getIsRecording()));
                ...
                new AsyncPostDataResponseNoProgress(FragmentPlayList.this, 4, nameValuePairs,
    ...
    private void setSongsList() {
        ...
        try {
            String data1 = AppUtils.getPlayList(context);
    ...
    private void getSongsListRefresh() {
        ...
        try {
            ...
            if (!cd.isConnectingToInternet()) {
                ...
                new AsyncPostDataResponseNoProgress(FragmentPlayList.this, 2, nameValuePairs,
                        getString(R.string.url_base)
                            ...
                            if (loading) {
                                if ((visibleItemCount + pastVisiblesItems) >= totalItemCount) {
                                    ...
                                    try {
                                        ...
                                        new AsyncPostDataResponseNoProgress(FragmentPlayList.this, 3, nameValuePairs,
                                                getString(R.string.url_base)
                                                        + getString(R.string.url_playlistList));
    ...
    public void onPostRequestSucess(int position, String response) {
        ...
        try {
            ...
            if (position == 1) {
                ...
                if (commandResult.getString("success").equalsIgnoreCase("1")) {
                    adapterPlayList.getFilter(favSongposition).setIsFavorite(is_like);
                    ...
                    arrayListSongs.remove(adapterPlayList.getFilter(favSongposition));
                    adapterPlayList.notifyDataSetChanged();
                    //   getSongsListRefresh();
                    //    mSwipeRefreshLayout.setRefreshing(true);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        searchView.setOnQueryTextListener(FragmentPlayList.this);
        ...
        MenuItemCompat.setOnActionExpandListener(item,
                new MenuItemCompat.OnActionExpandListener() {
                    ...
                    public boolean onMenuItemActionCollapse(MenuItem item) {
                        ...
                        if (arrayListSongs.size() > 0) {
                            adapterPlayList.setFilter(arrayListSongs);
                        }
    ...
    public boolean onQueryTextSubmit(String query) {
        if (arrayListSongs.size() > 0) {
            ...
            adapterPlayList.setFilter(filteredModelList);
        }
        return true;
    }
