 ...
 */
public class AdapterPopularSongList extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterPopularSongList(Context context, OnCustomItemClicListener lis, ArrayList<ModelVideo> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.row_popularsonglist, parent, false);
