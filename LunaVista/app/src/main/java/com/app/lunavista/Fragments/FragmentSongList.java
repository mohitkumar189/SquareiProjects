...
public class FragmentSongList extends Fragment implements ListenerPostData, OnCustomItemClicListener, SearchView.OnQueryTextListener {
    ...
    private void setSongsList() {
        ...
        try {
            String data1 = AppUtils.getSongsList(context);

            JSONObject songs = new JSONObject(data1);
            ...
            adapterSongList = new AdapterSongList(context, this, arrayListSongs);
            mRecyclerView.setAdapter(adapterSongList);
    ...
    public void onItemClickListener(int position, int flag) {
        ...
        if (flag == 1) {
            ModelVideo model = adapterSongList.getFilter(position);
            ...
            sharingIntent.putExtra(android.content.Intent.EXTRA_TEXT, "Listen " + model.getSongTitle() + " in Luna Vista, Also find many new video features, so what are u waiting for. " + "http://play.google.com/store/apps/details?id=" + context.getPackageName());
    ...
    private void likeUnlikeSong() {
        ...
        try {
            ...
            if (!cd.isConnectingToInternet()) {
                ...
                nameValuePairs
                        .add(new BasicNameValuePair(
                                "song_id", adapterSongList.getFilter(favSongposition).getSongId()));

                nameValuePairs
                        .add(new BasicNameValuePair(
                                "is_recording", adapterSongList.getFilter(favSongposition).getIsRecording()));
                ...
                new AsyncPostDataResponseNoProgress(FragmentSongList.this, 4, nameValuePairs,
    ...
    private void getSongsListRefresh() {
        ...
        try {
            ...
            if (!cd.isConnectingToInternet()) {
                ...
                new AsyncPostDataResponseNoProgress(FragmentSongList.this, 2, nameValuePairs,
                        getString(R.string.url_base)
                            ...
                            if (loading) {
                                if ((visibleItemCount + pastVisiblesItems) >= totalItemCount) {
                                    ...
                                    try {
                                        ...
                                        new AsyncPostDataResponseNoProgress(FragmentSongList.this, 3, nameValuePairs,
                                                getString(R.string.url_base)
                                                        + getString(R.string.url_songsList));
        ...
        try {
            ...
            if (position == 1) {
                ...
                if (commandResult.getString("success").equalsIgnoreCase("1")) {
                    ...
                    mRecyclerView.setAdapter(adapterSongList);
                    mSwipeRefreshLayout.setRefreshing(false);
                    AppUtils.setSongsList(context, data1.getJSONObject("Songs").toString());
                ...
                if (commandResult.getString("success").equalsIgnoreCase("1")) {
                    adapterSongList.getFilter(favSongposition).setIsFavorite(is_like);
                    adapterSongList.notifyDataSetChanged();
                    //   getSongsListRefresh();
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        searchView.setOnQueryTextListener(FragmentSongList.this);
        ...
        MenuItemCompat.setOnActionExpandListener(item,
                new MenuItemCompat.OnActionExpandListener() {
                    ...
                    public boolean onMenuItemActionCollapse(MenuItem item) {
                        ...
                        if (arrayListSongs.size() > 0) {
                            adapterSongList.setFilter(arrayListSongs);
                        }
    ...
    public boolean onQueryTextSubmit(String query) {
        if (arrayListSongs.size() > 0) {
            ...
            adapterSongList.setFilter(filteredModelList);
        }
        return true;
    }
