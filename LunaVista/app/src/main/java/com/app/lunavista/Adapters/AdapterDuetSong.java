 ...
 */
public class AdapterDuetSong extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterDuetSong(Context context, OnCustomItemClicListener lis, ArrayList<ModelVideo> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.row_duetsongs, parent, false);
