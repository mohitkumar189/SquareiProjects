 ...
 */
public class AdapterOngoingLeads extends RecyclerView.Adapter<AdapterOngoingLeads.CustomViewHolder> {
    ArrayList<ModelData> detail;
    Context mContext;
    OnCustomItemClicListener listener;

    public AdapterOngoingLeads(Context context, OnCustomItemClicListener lis, ArrayList<ModelData> list) {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int position) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.row_ongoing, viewGroup, false);
